...
class App
{
    ...
    public function __construct()
    {
        $this->dispatcher = FastRoute\simpleDispatcher(function (FastRoute\RouteCollector $r) {
            $r->addRoute(
                'GET',
                '/user/{id:\d+}/post/{post:\d+}',
                [
                    \Controller\HomeController::class, "user"
                ]
            );
            $r->addRoute(
                "GET",
    ...
    public function dispatch()
    {
        ...
        $handler = [$routeInfo[1][0], $routeInfo[1][1] . "Action"];
        $vars = $routeInfo[2];
    ...
    public function getDispatchRule($handler, $vars)
    {
        ...
        foreach ($method->getParameters() as $reflectionParameter) {
            ...
            if (isset($vars[$paramName])) {
                ...
                $params[$paramName] = $this->inject($reflectionParameter->getClass()->getName());
